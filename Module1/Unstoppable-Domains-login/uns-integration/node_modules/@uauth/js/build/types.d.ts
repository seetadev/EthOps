...
export declare type StandardResponseMode = 'fragment' | 'query';
export declare type FormPostResponseMode = 'form_post';
export declare type WebMessageResponseMode = 'web_message';
export declare type ResponseMode = StandardResponseMode | FormPostResponseMode | WebMessageResponseMode;
...
export declare type ClientAuthMethod = 'client_secret_basic' | 'client_secret_post' | 'none';
...
export declare type UAuthConstructorOptions = ClientOptions;
